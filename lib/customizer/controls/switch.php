...
if( class_exists( 'WP_Customize_Control' ) && !class_exists( 'Urban_Charity_Switch_Button_Control' ) ):
	/**
	* 
	*/
	class Urban_Charity_Switch_Button_Control extends WP_Customize_Control
	{
