...
if( class_exists( 'WP_Customize_Control' ) && !class_exists( 'Urban_Charity_Radio_Button_Control' ) ):
	/**
	* 
	*/
	class Urban_Charity_Radio_Button_Control extends WP_Customize_Control
	{
		public $urban_charity_type = 'radio_button';
