...
if( class_exists( 'WP_Customize_Control' ) && !class_exists( 'Urban_Charity_Multi_Select_Control' ) ):
	/**
	* 
	*/
	class Urban_Charity_Multi_Select_Control extends WP_Customize_Control
	{
		public $urban_charity_type = 'multi_select';
