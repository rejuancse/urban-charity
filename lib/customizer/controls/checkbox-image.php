...
if( class_exists( 'WP_Customize_Control' ) && !class_exists( 'Urban_Charity_Checkbox_Image_Control' ) ):
	/**
	* 
	*/
	class Urban_Charity_Checkbox_Image_Control extends WP_Customize_Control
	{
		public $urban_charity_type = 'checkbox_image';
